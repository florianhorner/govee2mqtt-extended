...
5. Enter `https://github.com/wez/govee2mqtt` and click "Add"
   > **Extended fork users:** Use `https://github.com/florianhorner/govee2mqtt-extended` instead if you need the extended fork with additional fixes and device support.
6. You should see:
